...
Docs:
[Feature Flags](https://docs.sentry.io/platforms/javascript/guides/react/feature-flags/)
· product overview:
...
Client-side React SPA. Add the integration next to the existing `Sentry.init` in the app
entry.
...
| --- | --- | --- |
| LaunchDarkly | `launchDarklyIntegration` + `buildLaunchDarklyFlagUsedHandler` | [LaunchDarkly](https://docs.sentry.io/platforms/javascript/guides/react/configuration/integrations/launchdarkly/) |
| OpenFeature | `openFeatureIntegration` + `OpenFeatureIntegrationHook` | [OpenFeature](https://docs.sentry.io/platforms/javascript/guides/react/configuration/integrations/openfeature/) |
| Statsig | `statsigIntegration` | [Statsig](https://docs.sentry.io/platforms/javascript/guides/react/configuration/integrations/statsig/) |
| Unleash | `unleashIntegration` | [Unleash](https://docs.sentry.io/platforms/javascript/guides/react/configuration/integrations/unleash/) |

Import names live on the same `@sentry/react` package as the rest of the SDK.
