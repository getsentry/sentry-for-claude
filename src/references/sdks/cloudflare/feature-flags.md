...
Docs:
[Feature Flags](https://docs.sentry.io/platforms/javascript/guides/cloudflare/feature-flags/)
· product overview:
...
Workers/Pages via `@sentry/cloudflare`. Wire the integration in the worker’s
`Sentry.init` / `withSentry` options.
...
| --- | --- | --- |
| LaunchDarkly | `launchDarklyIntegration` + `buildLaunchDarklyFlagUsedHandler` | [LaunchDarkly](https://docs.sentry.io/platforms/javascript/guides/cloudflare/configuration/integrations/launchdarkly/) |
| OpenFeature | `openFeatureIntegration` + `OpenFeatureIntegrationHook` | [OpenFeature](https://docs.sentry.io/platforms/javascript/guides/cloudflare/configuration/integrations/openfeature/) |
| Statsig | `statsigIntegration` | [Statsig](https://docs.sentry.io/platforms/javascript/guides/cloudflare/configuration/integrations/statsig/) |
| Unleash | `unleashIntegration` | [Unleash](https://docs.sentry.io/platforms/javascript/guides/cloudflare/configuration/integrations/unleash/) |

Import names live on the same `@sentry/cloudflare` package as the rest of the SDK.
