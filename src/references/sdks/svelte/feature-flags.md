# Feature Flags — Svelte / SvelteKit
...
Docs:
[Feature Flags](https://docs.sentry.io/platforms/javascript/guides/svelte/feature-flags/)
· product overview:
...
Use `@sentry/svelte` or `@sentry/sveltekit` to match the app.
Init-time integrations same as other JS SDKs.
...
If the app uses `@sentry/svelte` (not Kit), import from that package instead.
...
| --- | --- | --- |
| LaunchDarkly | `launchDarklyIntegration` + `buildLaunchDarklyFlagUsedHandler` | [LaunchDarkly](https://docs.sentry.io/platforms/javascript/guides/svelte/configuration/integrations/launchdarkly/) |
| OpenFeature | `openFeatureIntegration` + `OpenFeatureIntegrationHook` | [OpenFeature](https://docs.sentry.io/platforms/javascript/guides/svelte/configuration/integrations/openfeature/) |
| Statsig | `statsigIntegration` | [Statsig](https://docs.sentry.io/platforms/javascript/guides/svelte/configuration/integrations/statsig/) |
| Unleash | `unleashIntegration` | [Unleash](https://docs.sentry.io/platforms/javascript/guides/svelte/configuration/integrations/unleash/) |

Import names live on the same `@sentry/sveltekit` package as the rest of the SDK.
