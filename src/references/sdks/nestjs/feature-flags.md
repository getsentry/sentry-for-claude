...
Docs:
[Feature Flags](https://docs.sentry.io/platforms/javascript/guides/nestjs/feature-flags/)
· product overview:
...
Add the integration in the same instrument file as `Sentry.init` (loaded before the Nest
app).
...
| --- | --- | --- |
| LaunchDarkly | `launchDarklyIntegration` + `buildLaunchDarklyFlagUsedHandler` | [LaunchDarkly](https://docs.sentry.io/platforms/javascript/guides/nestjs/configuration/integrations/launchdarkly/) |
| OpenFeature | `openFeatureIntegration` + `OpenFeatureIntegrationHook` | [OpenFeature](https://docs.sentry.io/platforms/javascript/guides/nestjs/configuration/integrations/openfeature/) |
| Statsig | `statsigIntegration` | [Statsig](https://docs.sentry.io/platforms/javascript/guides/nestjs/configuration/integrations/statsig/) |
| Unleash | `unleashIntegration` | [Unleash](https://docs.sentry.io/platforms/javascript/guides/nestjs/configuration/integrations/unleash/) |

Import names live on the same `@sentry/nestjs` package as the rest of the SDK.
