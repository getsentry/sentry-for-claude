...
Use the TanStack Start Sentry package already chosen in `index.md`. Integrations follow
the JS SDK pattern.
...
Import names live on the same `@sentry/tanstackstart-react` package as the rest of the
SDK.
