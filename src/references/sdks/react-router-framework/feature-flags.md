# Feature Flags — React Router Framework
...
Docs:
[Feature Flags](https://docs.sentry.io/platforms/javascript/guides/react-router/feature-flags/)
· product overview:
...
Use `@sentry/react-router` on the server/client inits where flags are evaluated.
...
| --- | --- | --- |
| LaunchDarkly | `launchDarklyIntegration` + `buildLaunchDarklyFlagUsedHandler` | [LaunchDarkly](https://docs.sentry.io/platforms/javascript/guides/react-router/configuration/integrations/launchdarkly/) |
| OpenFeature | `openFeatureIntegration` + `OpenFeatureIntegrationHook` | [OpenFeature](https://docs.sentry.io/platforms/javascript/guides/react-router/configuration/integrations/openfeature/) |
| Statsig | `statsigIntegration` | [Statsig](https://docs.sentry.io/platforms/javascript/guides/react-router/configuration/integrations/statsig/) |
| Unleash | `unleashIntegration` | [Unleash](https://docs.sentry.io/platforms/javascript/guides/react-router/configuration/integrations/unleash/) |

Import names live on the same `@sentry/react-router` package as the rest of the SDK.
