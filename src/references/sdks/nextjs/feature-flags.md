...
Docs:
[Feature Flags](https://docs.sentry.io/platforms/javascript/guides/nextjs/feature-flags/)
· product overview:
...
Add to client and/or server `Sentry.init` as appropriate for where flags are evaluated
(browser vs server components / route handlers).
...
| --- | --- | --- |
| LaunchDarkly | `launchDarklyIntegration` + `buildLaunchDarklyFlagUsedHandler` | [LaunchDarkly](https://docs.sentry.io/platforms/javascript/guides/nextjs/configuration/integrations/launchdarkly/) |
| OpenFeature | `openFeatureIntegration` + `OpenFeatureIntegrationHook` | [OpenFeature](https://docs.sentry.io/platforms/javascript/guides/nextjs/configuration/integrations/openfeature/) |
| Statsig | `statsigIntegration` | [Statsig](https://docs.sentry.io/platforms/javascript/guides/nextjs/configuration/integrations/statsig/) |
| Unleash | `unleashIntegration` | [Unleash](https://docs.sentry.io/platforms/javascript/guides/nextjs/configuration/integrations/unleash/) |

Import names live on the same `@sentry/nextjs` package as the rest of the SDK.
