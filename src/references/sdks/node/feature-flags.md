...
Docs:
[Feature Flags](https://docs.sentry.io/platforms/javascript/guides/node/feature-flags/)
· product overview:
...
Server-side Node (and Bun via `@sentry/bun`). Load integrations from the instrument file
that already calls `Sentry.init`.
...
| --- | --- | --- |
| LaunchDarkly | `launchDarklyIntegration` + `buildLaunchDarklyFlagUsedHandler` | [LaunchDarkly](https://docs.sentry.io/platforms/javascript/guides/node/configuration/integrations/launchdarkly/) |
| OpenFeature | `openFeatureIntegration` + `OpenFeatureIntegrationHook` | [OpenFeature](https://docs.sentry.io/platforms/javascript/guides/node/configuration/integrations/openfeature/) |
| Statsig | `statsigIntegration` | [Statsig](https://docs.sentry.io/platforms/javascript/guides/node/configuration/integrations/statsig/) |
| Unleash | `unleashIntegration` | [Unleash](https://docs.sentry.io/platforms/javascript/guides/node/configuration/integrations/unleash/) |

Import names live on the same `@sentry/node` package as the rest of the SDK.
